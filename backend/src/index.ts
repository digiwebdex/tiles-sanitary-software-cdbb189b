...
import projectAccountingRoutes from './routes/projectAccounting';
import fixedAssetsRoutes from './routes/fixedAssets';
import budgetsRoutes from './routes/budgets';
import generalLedgerRoutes from './routes/generalLedger';
import financialClosingRoutes from './routes/financialClosing';
import vatClosingRoutes from './routes/vatClosing';
import financialDashboardRoutes from './routes/financialDashboard';
...
app.use('/api/project-accounting', projectAccountingRoutes);
app.use('/api/fixed-assets', fixedAssetsRoutes);
app.use('/api/budgets', budgetsRoutes);
app.use('/api/general-ledger', generalLedgerRoutes);
app.use('/api/financial-closing', financialClosingRoutes);
app.use('/api/vat-closing', vatClosingRoutes);
